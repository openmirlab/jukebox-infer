import torch as t
import numpy as np
from jukebox_infer.data.artist_genre_processor import ArtistGenreProcessor
from jukebox_infer.data.text_processor import TextProcessor
...
class Labeller():
    ...
    def set_y_lyric_tokens(self, ys, labels):
        ...
        if self.n_tokens > 0:
            ...
            # Get device from ys tensor instead of hardcoding CUDA
            device = ys.device
