...
from jukebox_infer.transformer.ops import LayerNorm
from jukebox_infer.prior.autoregressive import ConditionalAutoregressive2D
from jukebox_infer.prior.conditioners import Conditioner, LabelConditioner
from jukebox_infer.data.labels import EmptyLabeller, Labeller

from jukebox_infer.utils.torch_utils import assert_shape
    ...
    def __init__(self, z_shapes, l_bins, encoder, decoder, level,
        ...
        if single_enc_dec:
            ...
            if self.n_tokens != 0 and self.use_tokens:
                from jukebox_infer.transformer.ops import Conv1D
